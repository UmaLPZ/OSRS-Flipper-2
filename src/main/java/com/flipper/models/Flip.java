...
public class Flip {
    ...
    public Flip(Transaction buy, Transaction sell) {
        this.flipId = UUID.randomUUID(); // Use the renamed field
        // this.userId = ...;  // We don't have user IDs yet
        ...
        this.buyPrice = buy.getFinPricePer(); // Use FinPricePer
        this.sellPrice = sell.getFinPricePer(); // Use FinPricePer
    ...
    public int getTotalProfit() {
        return (sellPrice - buyPrice) * quantity - getTotalTax(); // Use getTotalTax
    }
    ...
    public int getTax() {
        ...
        return Math.min(taxPerItem, Transaction.MAX_TAX); // Apply per-item cap
    }
    ...
    public int getTotalTax() {
        return getTax() * quantity; // Per-item tax * quantity
    }
}