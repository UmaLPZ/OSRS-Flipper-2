...
import com.flipper.views.components.InProgressHeader;
...
public class InProgressPanel extends JPanel {
    ...
    private JLabel quantityProgressLabel; // For "x / y" text
    ...
    public InProgressPanel(ItemComposition item, BufferedImage itemImage, GrandExchangeOffer offer) {
        ...
        // Progress label and bar will be added in updateOffer
        ...
        constructItemInfo(); // Initialize itemInfoContainer

        container.setBorder(UiUtilities.ITEM_INFO_BORDER);
        this.add(container, BorderLayout.NORTH); // Add main container to the panel
    ...
    private void constructItemInfo() {
        ...
        totalValuePanel.add(newRightLabel("0", ColorScheme.GRAND_EXCHANGE_ALCH), BorderLayout.EAST); // Placeholder
        ...
        pricePerPanel.add(newRightLabel("0", ColorScheme.GRAND_EXCHANGE_ALCH), BorderLayout.EAST); // Placeholder
        ...
        spentPanel.add(newRightLabel("0", ColorScheme.GRAND_EXCHANGE_ALCH), BorderLayout.EAST); // Placeholder
        ...
        spentPerPanel.add(newRightLabel("0", ColorScheme.GRAND_EXCHANGE_ALCH), BorderLayout.EAST); // Placeholder
    ...
    public void updateOffer(ItemComposition offerItem, BufferedImage itemImage, GrandExchangeOffer offer) {
        ...
        // --- Center Panel (Titles and Item Info) ---
